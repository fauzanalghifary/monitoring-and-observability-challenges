...
func (s *Store) FindBookingByID(ctx context.Context, ID string, opts ...FindOption) (
	*Booking,
	error,
) {
	ctx, span := tracer.Start(ctx, "FindBookingByID")
	defer span.End()
	options := &FindOptions{}
	for _, o := range opts {
		o(options)
	...
	query := sb.Select(
		"b.id", "c.id", "cb.id", "b.price", "b.currency", "b.status",
...
func (s *Store) UpdateBookingStatus(
	ctx context.Context,
	booking *Booking,
	opts ...UpdateOption,
) error {
	ctx, span := tracer.Start(ctx, "UpdateBookingStatus")
	defer span.End()
...
func (s *Store) UpdateBookingPayment(
	ctx context.Context,
	booking *Booking,
	opts ...UpdateOption,
) error {
...
func (s *Store) FindAllBookings(ctx context.Context, opts ...ListOption) (
	[]Booking,
	string,
	error,
) {
